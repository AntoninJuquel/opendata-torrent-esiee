...
Les données que nous allons utiliser sont issues de fichiers torrent téléchargés à partir d'un site de téléchargement de torrent au choix, de plus nous utilisons ipinfo.io pour décoder les adresses IP et savoir dans quels pays ce fichier est téléchargé.
